...
from process_traffic_improvement_pipeline import pipeline
from utils.config import pipeline_config

def process_traffic_improvement_request():
    ...
    parameter_values = {
            ...
            "data_traffic_improvement_features_table_id": 
                pipeline_config["data_traffic_improvement_features_table_id"],
            "voice_traffic_improvement_features_table_id": 
                pipeline_config["voice_traffic_improvement_features_table_id"],
